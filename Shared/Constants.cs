...
namespace Management.Common
{
    public static class Constants
    {
        ...
        public static string IncorrectCredentials = "Entered Email or Password is incorrect!";
        public static string ResetSuccessfull = "Password Reset Successfull";
        public static string PasswordError = "Passwords must have at least one non alphanumeric character";
